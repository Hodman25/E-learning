    ...
    return <>
      <div className="text-center ">
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/1200x/1e/23/41/1e2341a9fd387f550118bafcebb34a24.jpg" alt="" />
            ...
            <div className="">
             <Link to='/courses/javascript/function'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
            {/* switch */}
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/1200x/1e/2b/09/1e2b09e7bbdb1c7390137a5051a0f9a2.jpg" alt="" />
            ...
            <div className="">
             <Link to='/courses/javascript/switch'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/736x/90/44/a6/9044a634e09b2a633ff73efad0fdf470.jpg" alt="" />
            ...
            <div className="mt-">
             <Link to='/courses/javascript/loops'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
