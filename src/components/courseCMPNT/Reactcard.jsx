    ...
    return <>
      <div className="text-center ">
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/1200x/72/d4/5a/72d45acc907d8e94a5be3acd3480c33f.jpg" alt="" />
            ...
            <div className="">
             <Link to='/courses/react/hooks'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
            {/* component */}
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/736x/be/23/ef/be23ef97f834d42f46a6c23f73c09934.jpg" alt="" />
            ...
            <div className="mt-2">
             <Link to='/courses/react/component'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
        ...
        <img className='h-60 w-full ' src="https://i.pinimg.com/1200x/f4/d7/59/f4d759fbe37a3445c0dc4908450b5015.jpg" alt="" />
            ...
            <div className="mt-2">
             <Link to='/courses/react/props'> <Button title='access lesson' px='w-full text-2xl hover:bg-orange-700 ' /></Link>
            </div>
            </div>
